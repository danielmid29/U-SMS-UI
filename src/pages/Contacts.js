...
export const Contacts = () => {
  ...
  return (
    <div className="campaign-main-container">
      ...
      <Buttons toggleShowNewContact={toggleShowNewContact} />
      <ContactTableCard
...
const Buttons = ({ toggleShowNewContact }) => {
  return (
    <div className="button-container">
      ...
      <Link to="/contact-group" className="button">
        ...
        <BiIcons.BiArrowFromLeft className="top-button-icon" />
      </Link>
    </div>
  );
};
...
const ContactTableCard = ({ toggleShowNewContact, showNewContact }) => {
